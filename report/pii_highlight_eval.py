...
#   → 換成你自己模型/系統的輸出即可
# ---------------------------------------------------------------------------
DETECTION_RESULT = [('本案理賠申請人為王志明（英文名 Chih-Ming', 'PERSON'), ('D287654321', 'TW_ID'), ('1985年3月14日', 'DATE_OF_BIRTH'), ('高雄市苓雅區四維三路168號9樓', 'ADDRESS'), ('0912-345-678', 'TW_PHONE'), ('chihming.wang@example.com', 'EMAIL'), ('Chia-Jung', 'PERSON'), ('20260214', 'US_BANK_NUMBER'), ('2026年2月14日', 'DATE_OF_BIRTH'), ('2026年2月20日', 'DATE_OF_BIRTH'), ('POL', 'ORGANIZATION'), ('A223456789', 'TW_ID'), ('0933-222-111', 'TW_PHONE'), ('013-001-0012345', 'BANK_ACCOUNT'), ('0800-123-456', 'PHONE_NUMBER'), ('07-2211334', 'PHONE_NUMBER'), ('claims@example-insurance.com.tw', 'EMAIL'), ('CLM-2026', 'LICENSE_PLATE'), ('2026年3月2日', 'DATE_OF_BIRTH'), ('位於高雄市新興區中山一路85號3樓', 'ADDRESS'), ('IP', 'ORGANIZATION'), ('203.74.12.88', 'IP_ADDRESS')]
